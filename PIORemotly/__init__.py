...
def parse_args():
    ...
    parent_parser.add_argument("--server", default="localhost:5001",
                               required=False, help="define server server (default: 'localhost:5001')")
    ...
    test_parser.add_argument(
        "--workdir", default=".", help="work directory which is holding the PlatformIO project (default: '.')")

    # agent
    agent_parser = service_subparsers.add_parser(
        "agent", help="run agent", parents=[parent_parser])
